...
**answerer's** half of the same wedge open. **60** is open and classified: §2al's claim that the
problem-50 discard is "exact rather than a race" is false, and that discard is scoped by arrival order
rather than by lifetime identity.

**TEST_PLAN §5.2's S-01…S-12 remain pending and no alignment figure exists.** Twelve passes have each
