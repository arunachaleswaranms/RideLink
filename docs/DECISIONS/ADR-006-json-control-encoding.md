...
([PROTOCOL §8.1](../PROTOCOL.md#81-transfer)) — base64 would add 33 % to the largest payloads
...
- Cost: manifests exceed one frame and must be chunked or delta'd — `MANIFEST_DELTA` and `manifest_revision` exist for this.
