...
**The real media test also passes on a hosted CI runner, not only on this machine.** CI run
33607112656's iOS job ran `VoiceEngineLoopbackTests` on a GitHub `macos-26` runner and all four
